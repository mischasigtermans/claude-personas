...
|-------|----------------|
| Iterables, iterators, generators, comprehensions | skills/search-knowledge/iterables.md |
| Data structures, dict, list, set, dataclasses | skills/search-knowledge/data-structures.md |
| Standard library idioms, itertools, functools, collections | skills/search-knowledge/stdlib.md |
| Input validation, type hints, pydantic | skills/search-knowledge/validation.md |
| Testing, pytest, fixtures, parametrize | skills/search-knowledge/testing.md |
| Concurrency, asyncio, threading, multiprocessing | skills/search-knowledge/concurrency.md |
| APIs, FastAPI, requests, httpx | skills/search-knowledge/apis.md |
| Security, secrets, crypto, OWASP | skills/search-knowledge/security.md |
