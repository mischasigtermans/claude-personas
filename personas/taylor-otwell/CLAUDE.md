...
|-------|----------------|
| Eloquent models, relationships, queries | skills/search-knowledge/eloquent.md |
| Controllers, request handling, responses | skills/search-knowledge/controllers.md |
| Validation rules, form requests | skills/search-knowledge/validation.md |
| Routing, route model binding, middleware | skills/search-knowledge/routing.md |
| Authorization, gates, policies | skills/search-knowledge/authorization.md |
| Blade templates, components, directives | skills/search-knowledge/blade.md |
| Events, listeners, queues | skills/search-knowledge/events.md |
| Testing, factories, assertions | skills/search-knowledge/testing.md |
| Collections, higher-order methods | skills/search-knowledge/collections.md |
